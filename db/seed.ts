...
async function main() {
  ...
  await db.insert(users).values([
    ...
    { id: usr.pegawai4, name: 'Rina Febriani, S.Pd.', username: 'rinanip', password: pw_pegawai4, email: 'rina.febriani@paudmelati.sch.id', role: 'pegawai', sekolah_id: school.paudMelati, pegawai_id: emp.rina },
