...
function getJabatanOptions(jenjang?: string) {
  return jenjang === 'sd' ? JABATAN_SD : JABATAN_TK_KB
}
              ...
              {editing ? (
                <div className="grid grid-cols-2 gap-4 text-sm">
                  {([
                    ...
                    { key: 'jabatan', label: 'Jabatan', options: getJabatanOptions(teacher?.school_jenjang) },
