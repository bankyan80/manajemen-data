    ...
    <AppShellTopbar>
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-zinc-200 p-12 text-center">
          ...
          <h3 className="font-semibold text-zinc-900 mb-2">Belum Ada Data Kegiatan &amp; Prestasi</h3>
          <p className="text-sm text-zinc-500 max-w-md mx-auto">
            Data kegiatan sekolah dan prestasi siswa belum diinput. Operator sekolah dapat menambahkan data kegiatan, lomba, dan prestasi melalui halaman ini.
          </p>
