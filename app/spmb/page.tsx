    ...
    <AppShellTopbar>
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-zinc-200 p-12 text-center">
          ...
          <h3 className="font-semibold text-zinc-900 mb-2">Belum Ada Data PPDB</h3>
          <p className="text-sm text-zinc-500 max-w-md mx-auto">
            Data penerimaan peserta didik baru belum diinput. Operator sekolah dapat menambahkan data pendaftar, daya tampung, dan jalur masuk melalui halaman ini.
          </p>
